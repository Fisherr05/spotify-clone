...
import { BehaviorSubject, switchAll } from 'rxjs';
...
export class MultimediaService {
  ...
  public timeEnlapsed$: BehaviorSubject<string> = new BehaviorSubject('00:00');
  ...
  private setPercentage(currenTime: number, duration: number): void {
  ...
  private setTimeElapsed(currentTime: number): void {
    ...
    this.timeEnlapsed$.next(displayFormat);
  }
  ...
  public setAudio(track: TrackModel): void {
    console.log('Voy a reproducir -->', track);
